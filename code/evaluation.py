...
parser.add_argument("--domain", dest="domain", type=str, metavar='<str>', default='speaker', help="domain of the corpus {restaurant, speaker}")
...
parser.add_argument("--emb-name",  type=str, help="The name to the word embeddings file", default="w2v_embedding")
...
assert args.domain in {'restaurant', 'beer', 'speaker'}
#assert args.domain in {'speaker'}
...
def evaluation(true, predict, domain):
    ...
    if domain == 'restaurant':
        ...
        for line in predict:
            label = line.strip()
            if label == 'durability' or label == 'design':
                label = 'design+durability'
        ...
        print(classification_report(true_label, predict_label, 
                                    ['design+durability', 'sound', 'price'], digits=3))
            #['durability', 'sound', 'design', 'price'], digits=3))
...
#cluster_map = {0: 'Food', 1: 'Miscellaneous', 2: 'Miscellaneous', 3: 'Food', 4: 'Miscellaneous', 5: 'Food', 6:'Price',  7: #'Miscellaneous', 8: 'Staff', 9: 'Food', 10: 'Food', 11: 'Anecdotes', 12: 'Ambience', 13: 'Staff'}

#cluster map for restaurant not using their pre-trained model
#cluster_map = {0: 'Price', 1: 'Miscellaneous', 2: 'Food', 3: 'Ambience', 4: 'Ambience', 5: 'Food', 6:'Anecdotes',  7: 'Food', #8: 'Staff', 9: 'Staff', 10: 'Miscellaneous', 11: 'Miscellaneous', 12: 'Food', 13: 'Miscellaneous'}


# headphone/speaker aspects: design, sound, duarbility, price, misc
# k=20 cluster map
#cluster_map = {0: 'design', 1: 'design', 2: 'design', 3: 'price', 4: 'design', 5: 'design', 6: 'sound', 7: 'misc', 
#               8: 'design', 9: 'sound', 10: 'design', 11: 'misc', 12: 'durability', 13: 'misc', 14: 'design', 15: 'design',
#               16: 'design', 17: 'durability', 18: 'design', 19: 'design'}

# k=20 cluster map, with 11000 word vocab
cluster_map = {0: 'design', 1: 'design', 2: 'design', 3: 'price', 4: 'sound', 5: 'design', 6: 'sound', 7: 'misc', 
               8: 'design', 9: 'sound', 10: 'design', 11: 'misc', 12: 'durability', 13: 'misc', 14: 'design', 15: 'design',
               16: 'misc', 17: 'durability', 18: 'design', 19: 'design'}

# 11000 word vocab cluster map
#cluster_map = {0: 'misc', 1: 'design', 2: 'design', 3: 'design', 4: 'design', 5: 'sound', 6: 'misc', 7: 'sound', 
#               8: 'design', 9: 'price', 10: 'design', 11: 'sound', 12: 'design', 13: 'price'}


print('--- Results on %s domain ---' % (args.domain))
test_labels = '../preprocessed_data/%s/test_label.txt' % (args.domain)
test = '../preprocessed_data/%s/test.txt' % (args.domain)

pred_labels = prediction(test_labels, aspect_probs, cluster_map, domain=args.domain)

pred_out = codecs.open(out_dir + '/test_pred.txt', 'w', 'utf-8')
sent_pred_act = codecs.open(out_dir + '/test_sent_pred_actual.txt', 'w', 'utf-8')

for label in pred_labels:
    pred_out.write(label + '\n')

for label, pred, sent in zip(open(test_labels), pred_labels, open(test)):
    sent_pred_act.write(label + '\t' + pred + '\t' + sent + '\n')
